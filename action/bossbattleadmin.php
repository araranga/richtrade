...
//$_GET['accounts_id'] = $accounts_id;
 ...
 $total = countquery("SELECT id FROM tbl_battle_boss");
 //primary query
 $limit = getlimit(10,$_GET['p']);
 $query = "SELECT * FROM tbl_battle_boss as a ORDER by id DESC $limit";
									...
									?>
                                        <tr>
                                            ...
                                            <td>
												...
												<?php
												$qpokes = mysql_query_md("SELECT * FROM tbl_bosses WHERE id='{$row['p2poke']}'");		
												...
												?>	
														...
														<div class='typedataholder'>
														   ...
														   <p class='idsdata'>
														   <a target='_newtab' href='index.php?pages=viewboss&pokeid=<?php echo $rowqpokes['hash']; ?>'>
														   ID:#<?php echo $rowqpokes['hash']; ?>
														   </a>
														   </p>
														   <span>Level:<?php echo $rowqpokes['level']; ?></span>
